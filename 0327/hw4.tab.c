...
{
  "$end", "error", "$undefined", "INT", "FLOAT", "PRINT", "INTNUMBER",
  "FLOATNUMBER", "ID", "'='", "'+'", "'-'", "';'", "$accept", "program",
  "stmtlist", "stmt", "def_stmt", "assign_stmt", "id_val", "stdout", YY_NULLPTR
};
#endif
...
{
      -3,     4,     5,     6,     7,    15,   -22,    -3,   -22,   -22,
     -22,     8,     9,    10,     0,   -22,   -22,   -22,   -22,   -22,
     -22,   -22,   -22,    -1,     0,     0,   -22,   -22,   -22
};
...
{
       0,     0,     0,     0,     0,     0,     2,     4,     7,     6,
       5,     0,     0,     0,     0,     1,     3,     8,     9,    16,
      13,    14,    15,     0,     0,     0,    10,    11,    12
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -22,   -22,    11,   -22,   -22,   -22,   -21,   -22
};
...
{
       1,     2,     3,    27,    28,     4,    20,    21,    22,    24,
      25,    26,    11,    12,    13,    15,    14,     0,    16,     0,
      17,    18,    19
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,    24,    25,     8,     6,     7,     8,    10,
      11,    12,     8,     8,     8,     0,     9,    -1,     7,    -1,
      12,    12,    12
};
...
static const yytype_int8 yystos[] =
{
      ...
      20,     8,     8,     8,     9,     0,    15,    12,    12,    12,
       6,     7,     8,    19,    10,    11,    12,    19,    19
};
...
#line 60 "practice.y"
				...
				for(int i = 0; i < currentIndex; i++) {
					if(strcmp(PlaceVariable[i].id, (yyvsp[-1].sval)) == 0) {
                        j=i;
                        Find = 1;
						break;
					}
				...
				if(Find == 1){
					...
					strcpy(PlaceVariable[currentIndex].id, (yyvsp[-1].sval));
...
#line 113 "practice.y"
                ...
                int j;
				for(int i = 0; i < currentIndex; i++) {
					if(strcmp(PlaceVariable[i].id, (yyvsp[-3].sval)) == 0) {
                        j=i;
                        Find = 1;
						indexID = i;
...
#line 178 "practice.y"
                ...
                int j;
				for(int i = 0; i < currentIndex; i++) {
					if(strcmp(PlaceVariable[i].id, (yyvsp[0].sval)) == 0) {
                        j=i;
                        Find = 1;
						strcpy((yyval.rval.type), PlaceVariable[i].type);
						if(strcmp(PlaceVariable[i].type, "FLOAT") == 0) {
							(yyval.rval.f) = PlaceVariable[i].floatValue;
						}
						else if(strcmp(PlaceVariable[i].type, "INT  ") == 0){
							(yyval.rval.i) = PlaceVariable[i].intValue;
						}
						break;
					}
                }
